...
export var johnMessage = "Hello, my name is John!";

export let johnMessage = "I am taking the Helio Training development course!";

export const johnSaying = "I am looking for an engineering job!";
